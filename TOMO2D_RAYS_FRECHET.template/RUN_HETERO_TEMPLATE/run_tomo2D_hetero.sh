...
##########################################################
# create gnu files for plotting target.gnu init.gnu final.gnu
#
##########################################################
...
echo "set rmargin at screen 0.85" >> target.gnu
echo "set lmargin at screen 0.15" >> target.gnu
...
echo "set rmargin at screen 0.85" >> final.gnu
echo "set lmargin at screen 0.15" >> final.gnu
...
echo "set rmargin at screen 0.85" >> init.gnu
echo "set lmargin at screen 0.15" >> init.gnu
...
../BIN/tomo2D_Frechet
mv fcal_init.dat data_init.dat
...
echo for this example 101 and 201 are requested grid sizes
echo @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
exit 0
fi
fi
